...
\NP  
\absauth{Thorsten Altenkirch}
\meettitle{Should Type Theory replace Set Theory as the Foundation of Mathematics?}
\affil{The University of Nottingham}
\meetemail{txa@cs.nott.ac.uk}

%% INSERT TEXT OF ABSTRACT DIRECTLY BELOW

Set theory in the form of Zermelo-Fraenkel's axiomatic set theory is
...
number of implementations providing the base for formal developments.
